...
$this->title= 'ENTREPRENEURIAL LEADERSHIP INDEX';
...
?>
	...
	<div class="home">
		<div class="home_background" style="background-image: url(<?=$directoryAsset?>/img/jeli.jpg);"></div>
		<div class="home_content">
			<div class="container">
				<div class="row">
					<div class="col text-center">
					
					<h1 class="home_title" style="color:#FFFFFF;text-shadow: 1px 1px 2px black, 0 0 25px black, 0 0 5px black;">
	Entrepreneurial Leadership Index <br />(ELI)
	</h1></div>
				</div>

	<div class="row">
	<div class="col-md-3"></div>
<div class="col-md-3"><div class="home_button trans_200"><a href="<?=Url::to(['user/login'])?>">GET TO MY PAGE</a> </div> </div>
<div class="col-md-3"><div class="login_button trans_200"><a href="<?=Url::to(['user/register'])?>">REGISTER</a> </div><br /> </div>
</div>
	...
	/*  <div class="courses">
		<div class="container">
			<div class="row">
				<div class="col">
					<h2 class="section_title text-center" id="about-index">About Index</h2>
				</div>
